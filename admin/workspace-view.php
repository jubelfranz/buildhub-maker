...
<div id="wm-workspace-gui">
    <!-- STEP 1: UPLOAD -->
    <div id="step-1">
        <h4 style="margin-top:0;"><?php esc_html_e("1. Preparation", "buildhub-maker"); ?></h4>
        <div style="background: #f9f9f9; border: 2px dashed #ccc; padding: 40px; text-align: center; border-radius: 6px;">
            ...
            <button id="btn-analyze" class="button button-primary button-large" style="height: 45px; padding: 0 40px; font-weight: bold;"><?php esc_html_e("Start Analysis", "buildhub-maker"); ?></button>
        </div>
    </div>
